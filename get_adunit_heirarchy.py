...
def main(client):
  ...
  dictforrootadunit = dict(itertools.izip_longest(*[iter(root_ad_unit)] * 2, fillvalue=""))
  if root_ad_unit:
    BuildAndDisplayAdUnitTree(root_ad_unit[0], all_ad_units)
    #BuildAndDisplayAdUnitTree(dictforrootadunit, all_ad_units)
  else:
